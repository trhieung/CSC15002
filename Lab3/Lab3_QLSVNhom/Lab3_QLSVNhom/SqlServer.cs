...
namespace Lab3_QLSVNhom
{
    public class SqlServer
    {
        ...
        public SqlServer(string sqlServerIPAdd = "localhost", string port = "1433", string DBName = "QLSVNhom", string username = null, string password = null)
        {
        ...
        public bool Connect(string tendn, string mk)
        {
            ...
            using (this.conn)
            {
                using (SqlCommand command = new SqlCommand("dbo.SP_CheckLogin_NHANVIEN", conn))
                {
